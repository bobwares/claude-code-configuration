---
name: security-scan
description: Run a security audit on changed files or the full codebase. Spawns the security-auditor agent. Arguments: scope (optional, e.g., "auth module" or "full").
