...
|-------|---------------|-----------|
| `orchestrator` | opus | Complex coordination requires high capability |
| `code-architect` | opus | Architectural decisions need deep reasoning |
| `code-reviewer` | opus | Thorough review needs attention to detail |
| `security-auditor` | opus | Security requires comprehensive analysis |
| `nextjs-engineer` | sonnet | Implementation tasks, balanced cost/capability |
| `nestjs-engineer` | sonnet | Implementation tasks |
| `spring-engineer` | sonnet | Implementation tasks |
| `drizzle-dba` | sonnet | Schema/query tasks |
| `ai-engineer` | sonnet | AI integration tasks |
| `test-writer` | sonnet | Test writing tasks |
| `verify-app` | sonnet | Verification and routing |
| `git-guardian` | haiku | Simple git operations |
| `doc-generator` | haiku | Template-based documentation |
